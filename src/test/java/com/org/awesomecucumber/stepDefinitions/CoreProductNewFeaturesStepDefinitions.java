...
public class CoreProductNewFeaturesStepDefinitions {
    ...
    private static final Logger logger = LogManager.getLogger(CoreProductNewFeaturesStepDefinitions.class);
    ...
    public void i_count_the_number_of_video_feeds() {
        ...
        logger.info("The total number of video feeds are " + coreProductNewsPage.getVideoFeedsCount().size());
    }
    ...
    public void i_count_the_feeds_those_are_present_in_the_page_greater_than_equal_to_days(int days) {
        ...
        logger.info("The total number of feeds with days greater than equal to " + days + " are " + numberOfFeeds);
    }
}