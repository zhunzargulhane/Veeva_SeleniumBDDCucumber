...
public class DerivedProductSixersHomeStepDefinitions {
    ...
    private static final Logger logger = LogManager.getLogger(DerivedProductSixersHomeStepDefinitions.class);
    ...
    public void i_count_the_number_of_slides_present_on_the_page() {
        logger.info("The number of slides are " + derivedProductSixersHomePage.getSlidesTitle().size());
    }
    ...
    public void validate_duration_for_each_slide() throws IOException {
        derivedProductSixersHomePage.waitUntilVisibilityOfAllElements(derivedProductSixersHomePage.getSlides());
